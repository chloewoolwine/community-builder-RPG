...
@export var growth_stage_texture_offset: Array[Vector2]
...
func change_growth_stage(stage: int) -> void:
	if stage < growth_stage_textures.size():
		...
		sprite_2d.offset.x = growth_stage_texture_offset[stage].x
		sprite_2d.offset.y = growth_stage_texture_offset[stage].y
	else:
		current_texture = growth_stage_textures.size()-1
		sprite_2d.texture = growth_stage_textures[growth_stage_textures.size()-1]
		sprite_2d.offset.x = growth_stage_texture_offset[growth_stage_textures.size()-1].x
		sprite_2d.offset.y = growth_stage_texture_offset[growth_stage_textures.size()-1].y
