...
@export var leaf_growth_texture_offset: Array[Vector2]
...
func fix_sprites() -> void: 
	if current_texture == -1:
		...
		sprite_2d.offset.x = leaf_growth_texture_offset[leaf_growth_texture_offset.size()-1].x
		sprite_2d.offset.y = leaf_growth_texture_offset[leaf_growth_texture_offset.size()-1].y
		sprite_2d_2.texture = null
		return
	sprite_2d.texture = growth_stage_textures[current_texture]
	sprite_2d.offset.x = growth_stage_texture_offset[current_texture].x
	sprite_2d.offset.y = growth_stage_texture_offset[current_texture].y
	sprite_2d_2.texture = null
	if current_texture > 0: 
		sprite_2d_2.texture = leaf_growth_textures[current_texture - 1] # baby sapling is 1 sprite
		sprite_2d_2.offset.x = leaf_growth_texture_offset[current_texture - 1].x
		sprite_2d_2.offset.y = leaf_growth_texture_offset[current_texture - 1].y
	sprite_2d.y_sort_enabled = true
	sprite_2d_2.y_sort_enabled = true
